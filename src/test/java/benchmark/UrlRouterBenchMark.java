...
import com.blade.mvc.route.mapping.dynamic.RadixTrieMapping;
...
public class UrlRouterBenchMark {
    ...
    private static RadixTrieMapping radixTrieMapping = new RadixTrieMapping();
    ...
    public static void prepare() throws Exception {
        ...
        RoutesReader.initMapping(routes, (httpMethod, path, variables) -> {
            ...
            radixTrieMapping.addRoute(httpMethod, route, variables);
        });
    ...
    @Test
    public void radixTrieInvokeBadUrl() {
        runTest("GET", radixTrieMapping, "/badUrl/whatever/sefesg/abc/136");
    }
    ...
    @Test
    public void radixTrieInvokeWildUrl() throws URISyntaxException, IOException {
        runTest("POST", radixTrieMapping, "/shuju/yemian/sgsgrsrhshhsh/component/shrrrshr444457");
    }
